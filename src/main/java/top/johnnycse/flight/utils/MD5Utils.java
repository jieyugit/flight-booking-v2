...
public class MD5Utils {
    protected static String salt = "YuJieIsAHandsomeBoy";
    ...
    public static boolean valid(String text, String md5) {
        return md5.equals(MD5Upper(text)) || md5.equals(MD5(text).toUpperCase());
    }

    public static boolean valid(String text,String md5,String salt){
        return md5.equals(MD5Upper(text,salt));
    }

    public static void main(String[] args) {
        System.out.println(MD5Utils.MD5Lower("test",salt));
    }
