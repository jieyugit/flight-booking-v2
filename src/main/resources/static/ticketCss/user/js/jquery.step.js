...
(function (factory) {
    ...
    if (typeof define === 'function') {
      ...
      define.cmd&&define('jquery-step', ['ticketCss/user/js/jquery'], function (require, exports, moudles) {
            var $=require("ticketCss/user/js/jquery");
            factory($);
            return $;
        });
      define.amd&&define(['ticketCss/user/js/jquery'], factory);
    } else {
